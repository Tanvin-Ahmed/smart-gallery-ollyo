...
const Overlay: React.FC<OverlayProps> = ({
  ...
  return selectedImages.includes(id) ? (
    ...
    <div className="cursor-pointer rounded overlay absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300 ease-in-out z-20">
      <div className="py-5">
        <input
          type="checkbox"
          className="cursor-pointer h-6 w-16"
